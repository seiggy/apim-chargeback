...
✅ Limited only by the Azure Container App request size limit (default 100MB). The APIM 8KB log truncation problem is bypassed by forwarding full payloads via outbound policy.
